...
public class ElectronicSteps {
    ...
    public void iFillTheMandatoryFields() {
        new RegisterPage().enterFirstname("Maitri");
        new RegisterPage().enterLastname("Borad");
        new RegisterPage().enterEmail(email);
        new RegisterPage().enterPassword("Maitri@123");
        new RegisterPage().enterConfirmPassword("Maitri@123");
    }
