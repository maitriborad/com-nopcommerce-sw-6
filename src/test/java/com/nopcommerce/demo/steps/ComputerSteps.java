...
public class ComputerSteps {
    ...
    public void iVerifyThatUserNavigatedToBuildYourComputerPageUsing(String expected) throws InterruptedException {
       Assert.assertEquals(new TopMenu().getHeadingText(),expected,"User is not navigated to Build your Computer page");
    }
    ...
    public void iSelectOSRadio(String os) {
       new BuildYourComputerPage().selectOs(os);
    }

    @And("^I Check Check-box \"([^\"]*)\"$")
    public void iCheckCheckBox(String software) {
      new BuildYourComputerPage().selectSoftware(software);
    }

    @Then("^I Verify the price \"([^\"]*)\"$")
    public void iVerifyThePrice(String expected) throws InterruptedException {
      Assert.assertEquals(new BuildYourComputerPage().getPrice(),expected,"Price is not matching");
    }
    ...
    public void iVerifyTheSuccessMessageOnTopGreenBar(String expected) throws InterruptedException {
       Assert.assertEquals(new BuildYourComputerPage().getSuccessMessage(),expected,"Product is not added to cart successfully");
    }
    ...
    public void iFillTheAllMandatoryField() {
        new BillingPage().enterFirstname("Maitri");
        new BillingPage().enterLastname("Borad");
        new BillingPage().enterEmail("Boradm@gmail.com");
    ...
    public void iVerifyTheTextUsing(String expected) {
        Assert.assertEquals(new TopMenu().getWelcomeText(),expected,"User is not navigated");
    }
